...
FinalRecon là tool tự động hóa recon 

```bash
reDrose18@htb[/htb]$ git clone https://github.com/thewhiteh4t/FinalRecon.git
reDrose18@htb[/htb]$ cd FinalRecon
reDrose18@htb[/htb]$ pip3 install -r requirements.txt
reDrose18@htb[/htb]$ chmod +x ./finalrecon.py
reDrose18@htb[/htb]$ ./finalrecon.py --help
...
```bash
reDrose18@htb[/htb]$ ./finalrecon.py --headers --whois --url http://inlanefreight.com
